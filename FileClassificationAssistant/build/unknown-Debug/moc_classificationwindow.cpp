...
template <> constexpr inline auto classificationWindow::qt_create_metaobjectdata<qt_meta_tag_ZN20classificationWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'updateFileStatistics'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'updateChart'
        QtMocHelpers::SlotData<void(const QMap<QString,int> &, int)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
        ...
        // Slot 'on_pushButton_size_clicked'
    ...
    return QtMocHelpers::metaObjectData<classificationWindow, qt_meta_tag_ZN20classificationWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject classificationWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20classificationWindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20classificationWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN20classificationWindowE_t>.metaTypes,
    nullptr
} };
...
void *classificationWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20classificationWindowE_t>.strings))
